...
{ id:8, title:'Both Hands & Volume', sub:'Using left and right together', piece:'Gymnopédie No. 1 (Both Hands)',
  ...
  walkthrough: [
    "This study uses the same gentle feel as Satie's Gymnopédie — soft, slow — but everything is in C major (white keys only) and 4/4 time.",
    "RIGHT HAND: mostly steps and small skips. E–D–E in bar 1, then G–E–D–C stepping down in bar 2.",
    "LEFT HAND: one whole note per bar. It holds a bass note while the right hand plays the melody. Very simple — just hold each key.",
    "It's marked p (soft). Keep the touch light and gentle.",
    "Count in fours: 1, 2, 3, 4. Start with the right hand alone, then add the left.",
  ],
...
{ id:9, title:'Small Leaps', sub:'Bigger jumps: 4ths and 5ths', piece:'Für Elise (Opening)',
  ...
  walkthrough: [
    "This is a leap-practice study in C major (same moves as Für Elise's opening, but no sharps yet).",
    "Bar 1: the C–B–C–B motif uses steps, then C–G is a 4th down, then G–C is a 4th back up.",
    "Bar 2: E–C is a 3rd, C–G is a 4th, G–C is another 4th. Practice feeling those jumps.",
    "Bar 3: F–A is a 3rd, A–C is a 3rd, C–A back down. All steps and skips here.",
    "Bar 4: G–C is a 4th, C–E is a 3rd, E–C back down. When you're ready for the real A minor version with sharps, these moves will be in your hands.",
  ],
...
{ id:10, title:'How to Play Each Note', sub:'Short, smooth, loud, held', piece:'Minuet in G Minor (Simple)',
  ...
  walkthrough: [
    "This minuet-style study is in C major, 4/4, so you can focus purely on articulation — not keys or time signatures.",
    "Bar 1: Three STACCATO notes (C, D, E) — short and bouncy — then C without staccato. Feel the difference.",
    "Bar 2: The E has an ACCENT (>) — hit it a bit louder than its neighbors. Then step down E–D–C–B.",
    "Bar 3: A SLUR connecting C–D–E–D — play these four notes smooth and connected (legato).",
    "Bar 4: Two STACCATO notes (C, E), then D, then C with a FERMATA — hold that last note longer than written. A musical deep breath.",
  ],
